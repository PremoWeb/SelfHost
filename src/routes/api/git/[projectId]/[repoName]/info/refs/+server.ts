...
/**
 * Git Smart HTTP Protocol - info/refs endpoint
 * Handles: GET /api/git/:projectId/:repoName/info/refs?service=git-upload-pack
 *         GET /api/git/:projectId/:repoName/info/refs?service=git-receive-pack
 */
export const GET: RequestHandler = async ({ params, url, locals }) => {
	...
	// git-upload-pack = read (pull/clone)
