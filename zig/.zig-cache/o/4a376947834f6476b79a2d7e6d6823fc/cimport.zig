...
pub const SQLITE_VERSION = "3.51.2";
pub const SQLITE_VERSION_NUMBER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 3051002, .decimal);
pub const SQLITE_SOURCE_ID = "2026-01-09 17:27:48 b270f8339eb13b504d0b2ba154ebca966b7dde08e40c3ed7d559749818cbalt1";
pub const SQLITE_SCM_BRANCH = "branch-3.51";
pub const SQLITE_SCM_TAGS = "release version-3.51.2";
pub const SQLITE_SCM_DATETIME = "2026-01-09T17:27:48.405Z";
