...
<div class="space-y-6">
	...
	{#if (data as { isGod?: boolean }).isGod && data.servers.length === 0}
		<div
			class="border-yellow-200 bg-yellow-50 dark:border-yellow-800 dark:bg-yellow-950/50 flex items-center justify-between gap-4 rounded-lg border px-4 py-3"
		>
			<p class="text-muted-foreground text-sm">
				You're in God mode but no servers were returned. The backend may not have recognized your
				session. Try <strong>Retry</strong> or log out and back in to refresh your session.
			</p>
